...
var _ChildNodesWrapper = _interopRequireDefault(__webpack_require__(/*! ./ChildNodesWrapper */ "../src/ChildNodesWrapper.js"));
...
var _NodeItem = _interopRequireDefault(__webpack_require__(/*! ./NodeItem */ "../src/NodeItem.js"));
...
function (_Component) {
  ...
  function TreeNode() {
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)), "_shouldUpdate", false);
  ...
  (0, _createClass2.default)(TreeNode, [{
    ...
    key: "shouldUpdateTreeNode",
    value: function shouldUpdateTreeNode() {
...
var _demo2 = _interopRequireDefault(__webpack_require__(/*! ./demos/demo2 */ "./src/demos/demo2.js"));

var _demo3 = _interopRequireDefault(__webpack_require__(/*! ./demos/demo3 */ "./src/demos/demo3.js"));

var _demo4 = _interopRequireDefault(__webpack_require__(/*! ./demos/demo4 */ "./src/demos/demo4.js"));

var _demo5 = _interopRequireDefault(__webpack_require__(/*! ./demos/demo5 */ "./src/demos/demo5.js"));
...
function (_Component) {
  ...
  function DEMO(props) {
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)), "toggleExpand", function (node, e, t) {
      node.expanded = !node.expanded;
      node.checked = !node.checked;

      _this.forceUpdate(); //or
      // t.toggleExpand()
...
function (_Component) {
  ...
  function DEMO(props) {
    ...
    (0, _classCallCheck2.default)(this, DEMO);
    _this = (0, _possibleConstructorReturn2.default)(this, (0, _getPrototypeOf2.default)(DEMO).call(this, props));
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)), "dataStore", {});
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)), "loadData", function (node) {
      if (_this.dataStore[node.id]) return _this.dataStore[node.id];
      return new _promise.default(function (resolve) {
        var server = _this.store;
        setTimeout(function () {
          var childs = server.getChildren(node.id);
          _this.dataStore[node.id] = childs;
          resolve(childs);
        }, 500);
      });
    });
...
function (_Component) {
  ...
  function DEMO(_props) {
    ...
    (0, _classCallCheck2.default)(this, DEMO);
    _this = (0, _possibleConstructorReturn2.default)(this, (0, _getPrototypeOf2.default)(DEMO).call(this, _props));
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)), "loadData", function (node) {
      var store = _this.store;
      return store.getChildren(node.id);
    });
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)), "renderIndentIcons", function (node, props, item) {
      var store = _this.store;
      var pIds = store.getParentIds(node.id);
      return pIds.map(function (pId, i) {
        var _classnames;

        var isLastChild = store.isLastChild(pId);
        var classes = (0, _classnames3.default)((_classnames = {}, (0, _defineProperty2.default)(_classnames, props.className, true), (0, _defineProperty2.default)(_classnames, 'nil-tree-empty', isLastChild), (0, _defineProperty2.default)(_classnames, 'nil-tree-line', !isLastChild), _classnames));
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)), "renderExpanderIcon", function (node, props, item) {
      var _classnames2;

      var store = _this.store;
      var isLastChild = store.isLastChild(node.id);
      var leaf = node.leaf;
      var classes = (0, _classnames3.default)((_classnames2 = {}, (0, _defineProperty2.default)(_classnames2, props.className, true), (0, _defineProperty2.default)(_classnames2, 'nil-tree-expander-end', !leaf && isLastChild), (0, _defineProperty2.default)(_classnames2, 'nil-tree-expander', !leaf && !isLastChild), (0, _defineProperty2.default)(_classnames2, 'nil-tree-elbow-end', leaf && isLastChild), (0, _defineProperty2.default)(_classnames2, 'nil-tree-elbow', leaf && !isLastChild), _classnames2));
      return _react.default.createElement("span", (0, _extends2.default)({}, props, {
        className: classes
      }));
    });
...
var childNodesWrapperComponent =
/*#__PURE__*/
function (_Component) {
  (0, _inherits2.default)(childNodesWrapperComponent, _Component);

  function childNodesWrapperComponent() {
    var _getPrototypeOf2;

    var _this;

    (0, _classCallCheck2.default)(this, childNodesWrapperComponent);

    for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    _this = (0, _possibleConstructorReturn2.default)(this, (_getPrototypeOf2 = (0, _getPrototypeOf3.default)(childNodesWrapperComponent)).call.apply(_getPrototypeOf2, [this].concat(args)));
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)), "_timer", null);
    return _this;
  }

  (0, _createClass2.default)(childNodesWrapperComponent, [{
    key: "componentDidMount",
    value: function componentDidMount() {
      var _this2 = this;
    ...
    value: function render() {
      var _this$props = this.props,
          children = _this$props.children,
          expanded = _this$props.expanded,
          others = (0, _objectWithoutProperties2.default)(_this$props, ["children", "expanded"]);
      if (!expanded) return null;
      var childs = children();
      return !(0, _isArray.default)(childs) ? null : _react.default.createElement("div", (0, _extends2.default)({}, others, {
        style: {
  ...
  return childNodesWrapperComponent;
}(_react.Component);
/**
...
function (_Component2) {
  (0, _inherits2.default)(DEMO, _Component2);

  function DEMO(props) {
    var _this3;

    (0, _classCallCheck2.default)(this, DEMO);
    _this3 = (0, _possibleConstructorReturn2.default)(this, (0, _getPrototypeOf3.default)(DEMO).call(this, props));
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this3)), "dataStore", {});
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this3)), "loadData", function (node) {
      if (_this3.dataStore[node.id]) return _this3.dataStore[node.id];
      return new _promise.default(function (resolve) {
        var server = _this3.store;
        setTimeout(function () {
          var childs = server.getChildren(node.id);
          _this3.dataStore[node.id] = childs;
          resolve(childs);
        }, 500);
      });
    });
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this3)), "toggleExpand", function (node, e, t) {
      // node.expanded = !node.expanded;
      // this.forceUpdate();
      // or
      t.toggleExpand();
    });
    _this3.store = new _xtreeStore.default(_data.default, {
      simpleData: true
    });
    return _this3;
  }
...
function (_Component) {
  ...
  function DEMO(props) {
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)), "renderNodeRow", function (node, props, me) {
      var parentProps = me.props.parentProps;
      var showIcon = parentProps.showIcon,
          showExpanderIcon = parentProps.showExpanderIcon,
          checkable = parentProps.checkable;
      return _react.default.createElement("tr", null, _react.default.createElement("td", null, _react.default.createElement("div", me.getNodeProps(), me.renderIndentIcons(), node.loading ? me.renderLoadingIcon() : showExpanderIcon ? me.renderExpanderIcon() : null, showIcon ? me.renderIcon() : null, checkable ? me.renderCheckbox() : null, me.renderLabel(), me.renderExtIcons())), _react.default.createElement("td", {
        align: "center"
      }, node.id), _react.default.createElement("td", {
        align: "center"
      }, node.relativeDepth), _react.default.createElement("td", {
        align: "center"
      }, node.leaf ? '叶子' : '父级'));
    });
    _this.store = new _xtreeStore.default(_data.default, {
  ...
  (0, _createClass2.default)(DEMO, [{
    ...
    value: function render() {
      return _react.default.createElement("table", {
        ...
        borderspacing: "0"
      }, _react.default.createElement("thead", null, _react.default.createElement("tr", null, _react.default.createElement("th", null, "\u540D\u79F0"), _react.default.createElement("th", {
        width: 100,
        align: "center"
      }, "ID"), _react.default.createElement("th", {
        width: 100,
        align: "center"
      }, "\u5C42\u7EA7"), _react.default.createElement("th", {
        width: 100,
        align: "center"
      }, "\u7C7B\u578B"))), _react.default.createElement(_nilTree.default, {
        onNodeClick: this.toggleExpand,
        loadData: this.loadData,
        rootComponent: "tbody",
        loadingComponent: function loadingComponent(props) {
          return _react.default.createElement("tr", null, _react.default.createElement("td", (0, _extends2.default)({
            colSpan: 4
          }, props)));
        },
...
/******/ });
//# sourceMappingURL=app.b34d99e7.js.map