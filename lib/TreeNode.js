...
function (_Component) {
  ...
  _createClass(TreeNode, [{
    ...
    value: function renderExpanderIcon() {
      ...
      var classes = (0, _classnames.default)((_classNames = {}, _defineProperty(_classNames, "".concat(prefixCls, "-icon"), true), _defineProperty(_classNames, "".concat(prefixCls, "-expander-icon"), !isLeaf), _defineProperty(_classNames, "open", !isLeaf && this.isExpanded(node)), _defineProperty(_classNames, "".concat(prefixCls, "-indent"), isLeaf), _classNames));
      var expanderProps = {
        className: classes,
    ...
    value: function renderLoadingIcon() {
      ...
      var classes = (0, _classnames.default)((_classNames2 = {}, _defineProperty(_classNames2, "".concat(prefixCls, "-icon"), true), _defineProperty(_classNames2, "".concat(prefixCls, "-loading-icon"), true), _classNames2));
      return _react.default.createElement("span", {
        className: classes
      });
    }
    ...
    value: function renderIcon() {
      ...
      var isLeaf = this.isLeaf(node);
      var classes = (0, _classnames.default)((_classNames3 = {}, _defineProperty(_classNames3, "".concat(prefixCls, "-icon"), true), _defineProperty(_classNames3, "".concat(prefixCls, "-icon-parent"), !isLeaf), _defineProperty(_classNames3, "".concat(prefixCls, "-icon-leaf"), isLeaf), _defineProperty(_classNames3, node.iconCls, node.iconCls), _classNames3));
      return _react.default.createElement("span", {
        className: classes
      });
    }
    ...
    value: function renderCheckbox() {
      ...
      var classes = (0, _classnames.default)((_classNames4 = {}, _defineProperty(_classNames4, "".concat(prefixCls, "-icon"), true), _defineProperty(_classNames4, "".concat(prefixCls, "-icon-checkbox"), true), _defineProperty(_classNames4, "checked", !!node.checked), _classNames4));
      return _react.default.createElement("span", {
        className: classes
      });
    }
    ...
    value: function renderNode() {
      ...
      var nodeProps = {
        className: (0, _classnames.default)("".concat(prefixCls, "-item-wrapper"), (_classNames5 = {}, _defineProperty(_classNames5, node.cls, node.cls), _defineProperty(_classNames5, "".concat(prefixCls, "-item-expanded"), this.isExpanded(node)), _classNames5)),
        onClick: function onClick(e) {
